    ...
    it('should create inventory item with all optional fields', async () => {
      const response = await request(server!)
        ...
        .send({
          ...
          abv: '45',
          'Stock Number': 123,
          'Detailed Spirit Classification': 'Kentucky Straight Bourbon',
          'Distillation Method': 'Column Still',
          'Distillery Location': 'Kentucky, USA',
          'Age Statement or Barrel Finish': '7 Year',
          'Additional Notes': 'Great for cocktails',
          'Profile (Nose)': 'Caramel and vanilla',
