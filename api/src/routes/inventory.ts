...
function validateBottleData(record: any): { isValid: boolean; errors: string[]; sanitized?: any } {
  ...
  const category = explicitCategory || autoCategorize(type, classification, name);
...
/**
 * DELETE /api/inventory/bulk - Bulk Delete Inventory Items
 *
 ...
 * - DELETE /api/inventory/:id              - Delete bottle
 * - DELETE /api/inventory/bulk             - Bulk delete bottles
 * - POST   /api/inventory/import           - CSV import
 *
