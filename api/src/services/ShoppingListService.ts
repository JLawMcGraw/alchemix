...
const SYNONYMS: Record<string, string[]> = {
  ...
  'orange juice': ['oranges', 'fresh orange juice', 'fresh orange', 'oj'],
  'oranges': ['orange juice', 'fresh orange juice', 'fresh orange', 'oj'],
  'fresh orange juice': ['orange juice', 'oranges', 'fresh orange', 'oj'],
  'fresh orange': ['orange juice', 'oranges', 'fresh orange juice', 'oj'],
  'oj': ['orange juice', 'fresh orange juice', 'oranges', 'fresh orange'],
